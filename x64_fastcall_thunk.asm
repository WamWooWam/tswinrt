...
;
; tswinrt_windows_runtime_x64_fastcall_thunk -- Thunk for invoking an x64 fastcall function.
;
; Declared in C as:
;
;     int tswinrt_windows_runtime_x64_fastcall_thunk(void const*   fp,
...
tswinrt_windows_runtime_x64_fastcall_thunk PROC FRAME
...
tswinrt_windows_runtime_x64_fastcall_thunk ENDP
